 ...
 *
 * `TAG` es la primera columna y la llave de vínculo (`tagField`): el plugin de
 * Navisworks y el visor 3D cruzan cada fila con el modelo por su TAG (que en el
 * modelo vive en la pestaña nativa "Elemento" → Nombre/Capa). Ya no se usa una
 * columna `ID` artificial (se retiró el "camino B").
 */
